...
EQUATIONS  E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, E18, E19, E20, E21, E22, E23, E24, E25, E26, E27, E28, E29, E30, E31, E32, E33, E34, E35, E36, E37, E38, E39, E40, E41, E42, E43, E44, E45, E46, E47, E48, E49, E50, E51, E52, E53, E54, E55, E56, E57, E58, E59, E60, E61, E62, E63, E64, E65, E66, E67, E68, E69, E70, E71, E72, E73, E74, E75, E76, E77, E78, E79, E80, E81, E82, E83, E84, E85, E86, E87, E88, E89, E90, E91, E92, E93, E94, E95, E96, E97, E98, E99, E100, E101, E102, E103, E104, E105, E106, E107, E108, E109, E110, E111, E112, E113, E114, E115, E116, E117, E118, E119, E120, E121, E122, E123, E124, E125, E126, E127, E128, E129, E130, E131, E132, E133, E134, E135, E136, E137, E138, E139, E140, E141, E142, E143, E144, E145, E146, E147, E148, E149, E150, E151, E152, E153, E154, E155, E156, E157, E158, E159, E160, E161, E162, E163, E164, E165, E166, E167, E168, E169, E170, E171, E172, E173, E174, E175, E176, E177, E178, E179, E180, E181, E182, E183, E184, E185, E186, E187, E188, E189, E190, E191, E192, E193, E194, E195, E196, E197, E198, E199, E200, E201, E202, E203, E204, E205, E206, E207, E208, E209, E210, E211, E212, E213, E214, E215, E216, E217, E218, E219, E220, E221, E222, E223, E224, E225, E226, E227, E228, E229, E230, E231, E232, E233, E234, E235, E236, E237, E238, E239, E240, E241, E242, E243, E244, E245, E246, E247, E248, E249, E250, E251, E252, E253, E254, E255, E256, E257, E258, E259, E260, E261, E262, E263, E264, E265, E266, E267, E268, E269, E270, E271, E272, E273, E274, E275, E276, E277, E278, E279, E280, E281, E282, E283, E284, E285, E286, E287, E288, E289, E290, E291, E292, E293, E294, E295, E296, E297, E298, E299, E300, E301, E302, E303, E304, E305, E306, E307, E308, E309, E310, E311, E312, E313, E314, E315, E316, E317, E318, E319, E320, E321, E322, E323, E324, E325, E326, E327, E328, E329, E330, E331, E332, E333, E334, E335, E336, E337, E338, E339, E340, E341, E342, E343, E344, E345, E346, E347, E348, E349, E350, E351, E352, E353, E354;
...
E93 .. 2*X10 + SQR(X10) =G= -1;
E94 ..  - 2*X11 + SQR(X11) =G= -1;
E95 .. 2*X11 + SQR(X11) =G= -1;
E96 ..  - 2*X12 + SQR(X12) =G= -1;
E97 .. 2*X12 + SQR(X12) =G= -1;
E98 ..  - 2*X13 + SQR(X13) =G= -1;
E99 .. 2*X13 + SQR(X13) =G= -1;
E100 ..  - 2*X14 + SQR(X14) =G= -1;
E101 .. 2*X14 + SQR(X14) =G= -1;
E102 ..  - 2*X41 + SQR(X41) =G= -1;
E103 .. 2*X41 + SQR(X41) =G= -1;
E104 ..  - 2*X42 + SQR(X42) =G= -1;
E105 .. 2*X42 + SQR(X42) =G= -1;
E106 ..  - 2*X43 + SQR(X43) =G= -1;
E107 .. 2*X43 + SQR(X43) =G= -1;
E108 ..  - 2*X44 + SQR(X44) =G= -1;
E109 .. 2*X44 + SQR(X44) =G= -1;
E110 ..  - 2*X47 + SQR(X47) =G= -1;
E111 .. 2*X47 + SQR(X47) =G= -1;
E112 ..  - 2*X48 + SQR(X48) =G= -1;
E113 .. 2*X48 + SQR(X48) =G= -1;
E114 ..  - 2*X49 + SQR(X49) =G= -1;
E115 .. 2*X49 + SQR(X49) =G= -1;
E116 ..  - 2*X50 + SQR(X50) =G= -1;
E117 .. 2*X50 + SQR(X50) =G= -1;
E118 ..  - 2*X52 + SQR(X52) =G= -1;
E119 .. 2*X52 + SQR(X52) =G= -1;
E120 ..  - 2*X53 + SQR(X53) =G= -1;
E121 .. 2*X53 + SQR(X53) =G= -1;
E122 ..  - 2*X54 + SQR(X54) =G= -1;
E123 .. 2*X54 + SQR(X54) =G= -1;
E124 ..  - 2*X56 + SQR(X56) =G= -1;
E125 .. 2*X56 + SQR(X56) =G= -1;
E126 ..  - 2*X57 + SQR(X57) =G= -1;
E127 .. 2*X57 + SQR(X57) =G= -1;
E128 ..  - 2*X59 + SQR(X59) =G= -1;
E129 .. 2*X59 + SQR(X59) =G= -1;
E130 ..  - 2*X61 + SQR(X61) =G= -1;
E131 .. 2*X61 + SQR(X61) =G= -1;
E132 ..  - 2*X66 + SQR(X66) =G= -1;
E133 .. 2*X66 + SQR(X66) =G= -1;
E134 ..  - 2*X68 + SQR(X68) =G= -1;
E135 .. 2*X68 + SQR(X68) =G= -1;
E136 ..  - 2*X70 + SQR(X70) =G= -1;
E137 .. 2*X70 + SQR(X70) =G= -1;
E138 ..  - 2*X71 + SQR(X71) =G= -1;
E139 .. 2*X71 + SQR(X71) =G= -1;
E140 ..  - 2*X72 + SQR(X72) =G= -1;
E141 .. 2*X72 + SQR(X72) =G= -1;
E142 ..  - 2*X76 + SQR(X76) =G= -1;
E143 .. 2*X76 + SQR(X76) =G= -1;
E144 ..  - 2*X77 + SQR(X77) =G= -1;
E145 .. 2*X77 + SQR(X77) =G= -1;
E146 ..  - 2*X78 + SQR(X78) =G= -1;
E147 .. 2*X78 + SQR(X78) =G= -1;
E148 ..  - 2*X82 + SQR(X82) =G= -1;
E149 .. 2*X82 + SQR(X82) =G= -1;
E150 ..  - 2*X83 + SQR(X83) =G= -1;
E151 .. 2*X83 + SQR(X83) =G= -1;
E152 ..  - 2*X84 + SQR(X84) =G= -1;
E153 .. 2*X84 + SQR(X84) =G= -1;
E154 ..  - 2*X85 + SQR(X85) =G= -1;
E155 .. 2*X85 + SQR(X85) =G= -1;
E156 ..  - 2*X86 + SQR(X86) =G= -1;
E157 .. 2*X86 + SQR(X86) =G= -1;
E158 .. SQR(X9) - 2*X9*X10 + SQR(X10) =G= 0;
E159 .. SQR(X9) + 2*X9*X10 + SQR(X10) =G= 0;
E160 .. SQR(X9) - 2*X9*X11 + SQR(X11) =G= 0;
E161 .. SQR(X9) + 2*X9*X11 + SQR(X11) =G= 0;
E162 .. SQR(X9) - 2*X9*X12 + SQR(X12) =G= 0;
E163 .. SQR(X9) + 2*X9*X12 + SQR(X12) =G= 0;
E164 .. SQR(X9) - 2*X9*X13 + SQR(X13) =G= 0;
E165 .. SQR(X9) + 2*X9*X13 + SQR(X13) =G= 0;
E166 .. SQR(X9) - 2*X9*X14 + SQR(X14) =G= 0;
E167 .. SQR(X9) + 2*X9*X14 + SQR(X14) =G= 0;
E168 .. SQR(X9) - 2*X9*X41 + SQR(X41) =G= 0;
E169 .. SQR(X9) + 2*X9*X41 + SQR(X41) =G= 0;
E170 .. SQR(X9) - 2*X9*X42 + SQR(X42) =G= 0;
E171 .. SQR(X9) + 2*X9*X42 + SQR(X42) =G= 0;
E172 .. SQR(X9) - 2*X9*X47 + SQR(X47) =G= 0;
E173 .. SQR(X9) + 2*X9*X47 + SQR(X47) =G= 0;
E174 .. SQR(X9) - 2*X9*X48 + SQR(X48) =G= 0;
E175 .. SQR(X9) + 2*X9*X48 + SQR(X48) =G= 0;
E176 .. SQR(X9) - 2*X9*X49 + SQR(X49) =G= 0;
E177 .. SQR(X9) + 2*X9*X49 + SQR(X49) =G= 0;
E178 .. SQR(X9) - 2*X9*X50 + SQR(X50) =G= 0;
E179 .. SQR(X9) + 2*X9*X50 + SQR(X50) =G= 0;
E180 .. SQR(X9) - 2*X9*X52 + SQR(X52) =G= 0;
E181 .. SQR(X9) + 2*X9*X52 + SQR(X52) =G= 0;
E182 .. SQR(X9) - 2*X9*X53 + SQR(X53) =G= 0;
E183 .. SQR(X9) + 2*X9*X53 + SQR(X53) =G= 0;
E184 .. SQR(X9) - 2*X9*X54 + SQR(X54) =G= 0;
E185 .. SQR(X9) + 2*X9*X54 + SQR(X54) =G= 0;
E186 .. SQR(X9) - 2*X9*X56 + SQR(X56) =G= 0;
E187 .. SQR(X9) + 2*X9*X56 + SQR(X56) =G= 0;
E188 .. SQR(X9) - 2*X9*X57 + SQR(X57) =G= 0;
E189 .. SQR(X9) + 2*X9*X57 + SQR(X57) =G= 0;
E190 .. SQR(X9) - 2*X9*X59 + SQR(X59) =G= 0;
E191 .. SQR(X9) + 2*X9*X59 + SQR(X59) =G= 0;
E192 .. SQR(X9) - 2*X9*X61 + SQR(X61) =G= 0;
E193 .. SQR(X9) + 2*X9*X61 + SQR(X61) =G= 0;
E194 .. SQR(X9) - 2*X9*X66 + SQR(X66) =G= 0;
E195 .. SQR(X9) + 2*X9*X66 + SQR(X66) =G= 0;
E196 .. SQR(X9) - 2*X9*X70 + SQR(X70) =G= 0;
E197 .. SQR(X9) + 2*X9*X70 + SQR(X70) =G= 0;
E198 .. SQR(X9) - 2*X9*X72 + SQR(X72) =G= 0;
E199 .. SQR(X9) + 2*X9*X72 + SQR(X72) =G= 0;
E200 .. SQR(X9) - 2*X9*X76 + SQR(X76) =G= 0;
E201 .. SQR(X9) + 2*X9*X76 + SQR(X76) =G= 0;
E202 .. SQR(X9) - 2*X9*X77 + SQR(X77) =G= 0;
E203 .. SQR(X9) + 2*X9*X77 + SQR(X77) =G= 0;
E204 .. SQR(X9) - 2*X9*X82 + SQR(X82) =G= 0;
E205 .. SQR(X9) + 2*X9*X82 + SQR(X82) =G= 0;
E206 .. SQR(X9) - 2*X9*X83 + SQR(X83) =G= 0;
E207 .. SQR(X9) + 2*X9*X83 + SQR(X83) =G= 0;
E208 .. SQR(X9) - 2*X9*X84 + SQR(X84) =G= 0;
E209 .. SQR(X9) + 2*X9*X84 + SQR(X84) =G= 0;
E210 .. SQR(X9) - 2*X9*X85 + SQR(X85) =G= 0;
E211 .. SQR(X9) + 2*X9*X85 + SQR(X85) =G= 0;
E212 .. SQR(X9) - 2*X9*X86 + SQR(X86) =G= 0;
E213 .. SQR(X9) + 2*X9*X86 + SQR(X86) =G= 0;
E214 .. SQR(X10) - 2*X10*X11 + SQR(X11) =G= 0;
E215 .. SQR(X10) + 2*X10*X11 + SQR(X11) =G= 0;
E216 .. SQR(X10) - 2*X10*X12 + SQR(X12) =G= 0;
E217 .. SQR(X10) + 2*X10*X12 + SQR(X12) =G= 0;
E218 .. SQR(X10) - 2*X10*X13 + SQR(X13) =G= 0;
E219 .. SQR(X10) + 2*X10*X13 + SQR(X13) =G= 0;
E220 .. SQR(X10) - 2*X10*X14 + SQR(X14) =G= 0;
E221 .. SQR(X10) + 2*X10*X14 + SQR(X14) =G= 0;
E222 .. SQR(X10) - 2*X10*X47 + SQR(X47) =G= 0;
E223 .. SQR(X10) + 2*X10*X47 + SQR(X47) =G= 0;
E224 .. SQR(X10) - 2*X10*X48 + SQR(X48) =G= 0;
E225 .. SQR(X10) + 2*X10*X48 + SQR(X48) =G= 0;
E226 .. SQR(X10) - 2*X10*X49 + SQR(X49) =G= 0;
E227 .. SQR(X10) + 2*X10*X49 + SQR(X49) =G= 0;
E228 .. SQR(X10) - 2*X10*X52 + SQR(X52) =G= 0;
E229 .. SQR(X10) + 2*X10*X52 + SQR(X52) =G= 0;
E230 .. SQR(X10) - 2*X10*X53 + SQR(X53) =G= 0;
E231 .. SQR(X10) + 2*X10*X53 + SQR(X53) =G= 0;
E232 .. SQR(X10) - 2*X10*X54 + SQR(X54) =G= 0;
E233 .. SQR(X10) + 2*X10*X54 + SQR(X54) =G= 0;
E234 .. SQR(X10) - 2*X10*X61 + SQR(X61) =G= 0;
E235 .. SQR(X10) + 2*X10*X61 + SQR(X61) =G= 0;
E236 .. SQR(X10) - 2*X10*X76 + SQR(X76) =G= 0;
E237 .. SQR(X10) + 2*X10*X76 + SQR(X76) =G= 0;
E238 .. SQR(X10) - 2*X10*X77 + SQR(X77) =G= 0;
E239 .. SQR(X10) + 2*X10*X77 + SQR(X77) =G= 0;
E240 .. SQR(X10) - 2*X10*X78 + SQR(X78) =G= 0;
E241 .. SQR(X10) + 2*X10*X78 + SQR(X78) =G= 0;
E242 .. SQR(X10) - 2*X10*X83 + SQR(X83) =G= 0;
E243 .. SQR(X10) + 2*X10*X83 + SQR(X83) =G= 0;
E244 .. SQR(X10) - 2*X10*X85 + SQR(X85) =G= 0;
E245 .. SQR(X10) + 2*X10*X85 + SQR(X85) =G= 0;
E246 .. SQR(X10) - 2*X10*X86 + SQR(X86) =G= 0;
E247 .. SQR(X10) + 2*X10*X86 + SQR(X86) =G= 0;
E248 .. SQR(X11) - 2*X11*X12 + SQR(X12) =G= 0;
E249 .. SQR(X11) + 2*X11*X12 + SQR(X12) =G= 0;
E250 .. SQR(X11) - 2*X11*X13 + SQR(X13) =G= 0;
E251 .. SQR(X11) + 2*X11*X13 + SQR(X13) =G= 0;
E252 .. SQR(X11) - 2*X11*X14 + SQR(X14) =G= 0;
E253 .. SQR(X11) + 2*X11*X14 + SQR(X14) =G= 0;
E254 .. SQR(X11) - 2*X11*X53 + SQR(X53) =G= 0;
E255 .. SQR(X11) + 2*X11*X53 + SQR(X53) =G= 0;
E256 .. SQR(X11) - 2*X11*X54 + SQR(X54) =G= 0;
E257 .. SQR(X11) + 2*X11*X54 + SQR(X54) =G= 0;
E258 .. SQR(X11) - 2*X11*X56 + SQR(X56) =G= 0;
E259 .. SQR(X11) + 2*X11*X56 + SQR(X56) =G= 0;
E260 .. SQR(X11) - 2*X11*X57 + SQR(X57) =G= 0;
E261 .. SQR(X11) + 2*X11*X57 + SQR(X57) =G= 0;
E262 .. SQR(X11) - 2*X11*X59 + SQR(X59) =G= 0;
E263 .. SQR(X11) + 2*X11*X59 + SQR(X59) =G= 0;
E264 .. SQR(X11) - 2*X11*X61 + SQR(X61) =G= 0;
E265 .. SQR(X11) + 2*X11*X61 + SQR(X61) =G= 0;
E266 .. SQR(X11) - 2*X11*X66 + SQR(X66) =G= 0;
E267 .. SQR(X11) + 2*X11*X66 + SQR(X66) =G= 0;
E268 .. SQR(X11) - 2*X11*X70 + SQR(X70) =G= 0;
E269 .. SQR(X11) + 2*X11*X70 + SQR(X70) =G= 0;
E270 .. SQR(X11) - 2*X11*X77 + SQR(X77) =G= 0;
E271 .. SQR(X11) + 2*X11*X77 + SQR(X77) =G= 0;
E272 .. SQR(X11) - 2*X11*X82 + SQR(X82) =G= 0;
E273 .. SQR(X11) + 2*X11*X82 + SQR(X82) =G= 0;
E274 .. SQR(X11) - 2*X11*X83 + SQR(X83) =G= 0;
E275 .. SQR(X11) + 2*X11*X83 + SQR(X83) =G= 0;
E276 .. SQR(X11) - 2*X11*X84 + SQR(X84) =G= 0;
E277 .. SQR(X11) + 2*X11*X84 + SQR(X84) =G= 0;
E278 .. SQR(X12) - 2*X12*X13 + SQR(X13) =G= 0;
E279 .. SQR(X12) + 2*X12*X13 + SQR(X13) =G= 0;
E280 .. SQR(X12) - 2*X12*X14 + SQR(X14) =G= 0;
E281 .. SQR(X12) + 2*X12*X14 + SQR(X14) =G= 0;
E282 .. SQR(X12) - 2*X12*X57 + SQR(X57) =G= 0;
E283 .. SQR(X12) + 2*X12*X57 + SQR(X57) =G= 0;
E284 .. SQR(X12) - 2*X12*X61 + SQR(X61) =G= 0;
E285 .. SQR(X12) + 2*X12*X61 + SQR(X61) =G= 0;
E286 .. SQR(X12) - 2*X12*X84 + SQR(X84) =G= 0;
E287 .. SQR(X12) + 2*X12*X84 + SQR(X84) =G= 0;
E288 .. SQR(X12) - 2*X12*X85 + SQR(X85) =G= 0;
E289 .. SQR(X12) + 2*X12*X85 + SQR(X85) =G= 0;
E290 .. SQR(X12) - 2*X12*X86 + SQR(X86) =G= 0;
E291 .. SQR(X12) + 2*X12*X86 + SQR(X86) =G= 0;
E292 .. SQR(X13) - 2*X13*X14 + SQR(X14) =G= 0;
E293 .. SQR(X13) + 2*X13*X14 + SQR(X14) =G= 0;
E294 .. SQR(X13) - 2*X13*X59 + SQR(X59) =G= 0;
E295 .. SQR(X13) + 2*X13*X59 + SQR(X59) =G= 0;
E296 .. SQR(X13) - 2*X13*X70 + SQR(X70) =G= 0;
E297 .. SQR(X13) + 2*X13*X70 + SQR(X70) =G= 0;
E298 .. SQR(X13) - 2*X13*X84 + SQR(X84) =G= 0;
E299 .. SQR(X13) + 2*X13*X84 + SQR(X84) =G= 0;
E300 .. SQR(X13) - 2*X13*X86 + SQR(X86) =G= 0;
E301 .. SQR(X13) + 2*X13*X86 + SQR(X86) =G= 0;
E302 .. SQR(X14) - 2*X14*X61 + SQR(X61) =G= 0;
E303 .. SQR(X14) + 2*X14*X61 + SQR(X61) =G= 0;
E304 .. SQR(X14) - 2*X14*X78 + SQR(X78) =G= 0;
E305 .. SQR(X14) + 2*X14*X78 + SQR(X78) =G= 0;
E306 .. SQR(X14) - 2*X14*X82 + SQR(X82) =G= 0;
E307 .. SQR(X14) + 2*X14*X82 + SQR(X82) =G= 0;
E308 .. SQR(X14) - 2*X14*X85 + SQR(X85) =G= 0;
E309 .. SQR(X14) + 2*X14*X85 + SQR(X85) =G= 0;
E310 .. SQR(X14) - 2*X14*X86 + SQR(X86) =G= 0;
E311 .. SQR(X14) + 2*X14*X86 + SQR(X86) =G= 0;
E312 .. SQR(X41) - 2*X41*X66 + SQR(X66) =G= 0;
E313 .. SQR(X41) + 2*X41*X66 + SQR(X66) =G= 0;
E314 .. SQR(X42) - 2*X42*X47 + SQR(X47) =G= 0;
E315 .. SQR(X42) + 2*X42*X47 + SQR(X47) =G= 0;
E316 .. SQR(X42) - 2*X42*X53 + SQR(X53) =G= 0;
E317 .. SQR(X42) + 2*X42*X53 + SQR(X53) =G= 0;
E318 .. SQR(X42) - 2*X42*X57 + SQR(X57) =G= 0;
E319 .. SQR(X42) + 2*X42*X57 + SQR(X57) =G= 0;
E320 .. SQR(X43) - 2*X43*X52 + SQR(X52) =G= 0;
E321 .. SQR(X43) + 2*X43*X52 + SQR(X52) =G= 0;
E322 .. SQR(X43) - 2*X43*X57 + SQR(X57) =G= 0;
E323 .. SQR(X43) + 2*X43*X57 + SQR(X57) =G= 0;
E324 .. SQR(X44) - 2*X44*X56 + SQR(X56) =G= 0;
E325 .. SQR(X44) + 2*X44*X56 + SQR(X56) =G= 0;
E326 .. SQR(X44) - 2*X44*X83 + SQR(X83) =G= 0;
E327 .. SQR(X44) + 2*X44*X83 + SQR(X83) =G= 0;
E328 .. SQR(X47) - 2*X47*X50 + SQR(X50) =G= 0;
E329 .. SQR(X47) + 2*X47*X50 + SQR(X50) =G= 0;
E330 .. SQR(X47) - 2*X47*X76 + SQR(X76) =G= 0;
E331 .. SQR(X47) + 2*X47*X76 + SQR(X76) =G= 0;
E332 .. SQR(X48) - 2*X48*X52 + SQR(X52) =G= 0;
E333 .. SQR(X48) + 2*X48*X52 + SQR(X52) =G= 0;
E334 .. SQR(X48) - 2*X48*X83 + SQR(X83) =G= 0;
E335 .. SQR(X48) + 2*X48*X83 + SQR(X83) =G= 0;
E336 .. SQR(X49) - 2*X49*X59 + SQR(X59) =G= 0;
E337 .. SQR(X49) + 2*X49*X59 + SQR(X59) =G= 0;
E338 .. SQR(X49) - 2*X49*X83 + SQR(X83) =G= 0;
E339 .. SQR(X49) + 2*X49*X83 + SQR(X83) =G= 0;
E340 .. SQR(X50) - 2*X50*X59 + SQR(X59) =G= 0;
E341 .. SQR(X50) + 2*X50*X59 + SQR(X59) =G= 0;
E342 .. SQR(X50) - 2*X50*X70 + SQR(X70) =G= 0;
E343 .. SQR(X50) + 2*X50*X70 + SQR(X70) =G= 0;
E344 .. SQR(X50) - 2*X50*X86 + SQR(X86) =G= 0;
E345 .. SQR(X50) + 2*X50*X86 + SQR(X86) =G= 0;
E346 .. SQR(X52) - 2*X52*X66 + SQR(X66) =G= 0;
E347 .. SQR(X52) + 2*X52*X66 + SQR(X66) =G= 0;
E348 .. SQR(X54) - 2*X54*X59 + SQR(X59) =G= 0;
E349 .. SQR(X54) + 2*X54*X59 + SQR(X59) =G= 0;
E350 .. SQR(X57) - 2*X57*X70 + SQR(X70) =G= 0;
E351 .. SQR(X57) + 2*X57*X70 + SQR(X70) =G= 0;
E352 .. SQR(X57) - 2*X57*X84 + SQR(X84) =G= 0;
E353 .. SQR(X57) + 2*X57*X84 + SQR(X84) =G= 0;
E354 .. objvar =E= X0;
...
X5.UP = 0;
X10.LO = 0.71;
X10.UP = 2.536603627561488;
X12.LO = 1.011115099532348;
X12.UP = 2.75;
X14.LO = 0.7;
X14.UP = 2.191880453087864;
X6.LO = 0;
X6.UP = 0;
X9.LO = 0.66;
X9.UP = 2.73;
...
X7.LO = 0;
X7.UP = 0;
X11.LO = 0.931046086570502;
X11.UP = 1.37477308761181;
X8.LO = 0;
X8.UP = 24.76452983589525;
X0.LO = -23803.50264909522;
X0.UP = 236613.0109037192;
X41.LO = 0.4356;
X41.UP = 7.452900000000001;
X42.LO = 0.4686;
X42.UP = 6.924927903242863;
X43.LO = 0.6144904171365313;
X43.UP = 3.753130529180241;
X50.LO = 0.2201;
X50.UP = 6.798097721864789;
X53.LO = 0.9413947564919362;
X53.UP = 3.780625990932477;
X54.LO = 0.2886242868368556;
X54.UP = 3.684391874799651;
X56.LO = 1.02235374450231;
X56.UP = 7.5625;
X57.LO = 0.3134456808550278;
X57.UP = 7.370000000000001;
X58.LO = 0.7077805696726435;
X58.UP = 6.027671245991626;
X59.LO = 0.09609999999999999;
X59.UP = 7.182400000000001;
X63.LO = 0.4738085356408582;
X63.UP = 19.04355173391788;
X68.LO = 0.2068741493643184;
X68.UP = 20.1201;
X69.LO = 0.4671351759839447;
X69.UP = 16.45554250155714;
X70.LO = 0.063426;
X70.UP = 19.607952;
X71.LO = 0.14322;
X71.UP = 16.03667414697205;
X73.LO = 0.6683902771092746;
X73.UP = 9.589949603052569;
X77.LO = 0.15407;
X77.UP = 14.90061751473657;
X79.LO = 0.2918323745125002;
X79.UP = 10.13207765569904;
X80.LO = 0.6589763295443553;
X80.UP = 8.286680209960833;
X82.LO = 0.4562125824195459;
X82.UP = 6.604877226619341;
X83.LO = 0.3169296607957159;
X83.UP = 20.2675;
X85.LO = 0.4954463987708504;
X85.UP = 13.21193478172882;
X87.LO = 0.18974736;
X87.UP = 55.54571841000001;
X89.LO = 0.3775984727526282;
X89.UP = 14.08598876906476;
X94.LO = 0.305401737316856;
X94.UP = 20.86715018589389;
X95.LO = 0.146880646048666;
X95.UP = 51.03671864689991;
X96.LO = 0.3316659749486007;
X96.UP = 41.7411888029421;
X97.LO = 0.1016862;
X97.UP = 40.67868581523084;
X99.LO = 0.4349243774992744;
X99.UP = 22.62263697319308;
X100.LO = 0.1333444205186272;
X100.UP = 22.04678803205725;
X102.LO = 0.2541168099999999;
X102.UP = 41.40096240062982;
X103.LO = 0.436977479601928;
X103.UP = 12.16094325806124;
X104.LO = 0.5153685226036141;
X104.UP = 48.65983209789565;
X105.LO = 0.04844400999999998;
X105.UP = 46.21413263602324;
X108.LO = 0.1434462705579172;
X108.UP = 20.48496794805701;
X110.LO = 0.7514234012273865;
X110.UP = 3.572103940355147;
X114.LO = 0.2042826621587501;
X114.UP = 22.20830296269504;
X118.LO = 0.009235209999999997;
X118.UP = 51.58686976000002;
X47.LO = 0.5040999999999999;
X47.UP = 6.434357963358101;
X52.LO = 0.8668468153182467;
X52.UP = 1.890001042421709;
X64.LO = 0.145266;
X64.UP = 18.55880678069088;
X66.LO = 0.1904920293123247;
X66.UP = 10.05838981820305;
X74.LO = 0.2049232436541675;
X74.UP = 9.345841794974866;
X84.LO = 0.7156476211516166;
X84.UP = 16.57609592647697;
X86.LO = 0.06726999999999998;
X86.UP = 15.74296216625828;
X88.LO = 0.2195859599999999;
X88.UP = 47.9546264651116;
X98.LO = 0.1926093671782501;
X98.UP = 27.66057200005838;
X106.LO = 0.2470089999999999;
X106.UP = 30.91284282697625;
X109.LO = 0.1557825033849488;
X109.UP = 40.97669816552558;
X111.LO = 0.8862240875505115;
X111.UP = 14.29313288331418;
X113.LO = 0.4247549395059408;
X113.UP = 9.0802074581364;
X115.LO = 1.045207178897894;
X115.UP = 57.19140625;
X117.LO = 0.5009533348061316;
X117.UP = 36.33282064975425;
X119.LO = 0.04708899999999999;
X119.UP = 34.5066910459233;
X120.LO = 0.2400999999999999;
X120.UP = 23.0816820729462;
X48.LO = 0.6610427214650564;
X48.UP = 3.487254401110024;
X49.LO = 0.7178917206679669;
X49.UP = 6.975659975794093;
X75.LO = 0.4627299050255394;
X75.UP = 7.643644756737689;
X76.LO = 0.5025242044675767;
X76.UP = 15.28981274833044;
X91.LO = 0.04186115999999999;
X91.UP = 53.52970896000001;
X92.LO = 0.2134439999999999;
X92.UP = 35.80626499445335;
X55.LO = 0.6517322605993513;
X55.UP = 3.013338258167576;
X62.LO = 0.4362881961669372;
X62.UP = 9.520204515030368;
X65.LO = 0.6213205392846778;
X65.UP = 10.32110895524566;
X67.LO = 0.4301432919955718;
X67.UP = 8.226413444797481;
X81.LO = 0.2020370007857989;
X81.UP = 8.075746531889104;
X112.LO = 0.0833039789520835;
X112.UP = 13.57474348708969;
X116.LO = 0.09824819484667194;
X116.UP = 54.31690000000001;
X60.LO = 0.217;
X60.UP = 5.874239614275476;
X90.LO = 0.445337291105206;
X90.UP = 56.36255625;
X101.LO = 0.1448119045550228;
X101.UP = 44.10085390417314;
X61.LO = 0.4899999999999999;
X61.UP = 4.80433992062866;
X78.LO = 0.3478999999999999;
X78.UP = 12.18670607070513;
X107.LO = 0.4678731939764921;
X107.UP = 21.02002308102865;
X45.LO = 0.2046;
X45.UP = 7.316400000000001;
X44.LO = 0.6673359656913496;
X44.UP = 7.5075;
X46.LO = 0.462;
X46.UP = 5.983833636929869;
X51.LO = 0.4969999999999999;
X51.UP = 5.559931908483795;
X93.LO = 0.4411375828921212;
X93.UP = 26.18056241633352;
X72.LO = 0.3234;
X72.UP = 13.11584798331624;
X1.LO = 0;
X1.UP = 209.5333263011949;
X2.LO = -0;
X2.UP = 1144.759734168043;
X3.LO = -0;
X3.UP = 10154.50869897206;
X4.LO = -0;
X4.UP = 54776.98681693681;
