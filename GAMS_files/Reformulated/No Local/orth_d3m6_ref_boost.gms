...
E145 ..  - 2*X2 + SQR(X2) =G= -1;
E146 .. 2*X2 + SQR(X2) =G= -1;
E147 ..  - 2*X3 + SQR(X3) =G= -1;
E148 .. 2*X3 + SQR(X3) =G= -1;
E149 ..  - 2*X4 + SQR(X4) =G= -1;
E150 .. 2*X4 + SQR(X4) =G= -1;
E151 ..  - 2*X5 + SQR(X5) =G= -1;
E152 .. 2*X5 + SQR(X5) =G= -1;
...
E159 ..  - 2*X9 + SQR(X9) =G= -1;
E160 .. 2*X9 + SQR(X9) =G= -1;
E161 ..  - 2*X67 + SQR(X67) =G= -1;
E162 .. 2*X67 + SQR(X67) =G= -1;
E163 ..  - 2*X68 + SQR(X68) =G= -1;
E164 .. 2*X68 + SQR(X68) =G= -1;
E165 ..  - 2*X69 + SQR(X69) =G= -1;
E166 .. 2*X69 + SQR(X69) =G= -1;
E167 ..  - 2*X70 + SQR(X70) =G= -1;
E168 .. 2*X70 + SQR(X70) =G= -1;
E169 ..  - 2*X71 + SQR(X71) =G= -1;
E170 .. 2*X71 + SQR(X71) =G= -1;
E171 ..  - 2*X72 + SQR(X72) =G= -1;
E172 .. 2*X72 + SQR(X72) =G= -1;
E173 ..  - 2*X73 + SQR(X73) =G= -1;
E174 .. 2*X73 + SQR(X73) =G= -1;
E175 ..  - 2*X74 + SQR(X74) =G= -1;
E176 .. 2*X74 + SQR(X74) =G= -1;
E177 ..  - 2*X75 + SQR(X75) =G= -1;
E178 .. 2*X75 + SQR(X75) =G= -1;
E179 .. SQR(X63) - 2*X63*X2 + SQR(X2) =G= 0;
E180 .. SQR(X63) + 2*X63*X2 + SQR(X2) =G= 0;
E181 .. SQR(X63) - 2*X63*X3 + SQR(X3) =G= 0;
E182 .. SQR(X63) + 2*X63*X3 + SQR(X3) =G= 0;
E183 .. SQR(X63) - 2*X63*X4 + SQR(X4) =G= 0;
E184 .. SQR(X63) + 2*X63*X4 + SQR(X4) =G= 0;
E185 .. SQR(X63) - 2*X63*X67 + SQR(X67) =G= 0;
E186 .. SQR(X63) + 2*X63*X67 + SQR(X67) =G= 0;
E187 .. SQR(X63) - 2*X63*X68 + SQR(X68) =G= 0;
E188 .. SQR(X63) + 2*X63*X68 + SQR(X68) =G= 0;
E189 .. SQR(X63) - 2*X63*X69 + SQR(X69) =G= 0;
E190 .. SQR(X63) + 2*X63*X69 + SQR(X69) =G= 0;
E191 .. SQR(X63) - 2*X63*X70 + SQR(X70) =G= 0;
E192 .. SQR(X63) + 2*X63*X70 + SQR(X70) =G= 0;
E193 .. SQR(X63) - 2*X63*X71 + SQR(X71) =G= 0;
E194 .. SQR(X63) + 2*X63*X71 + SQR(X71) =G= 0;
E195 .. SQR(X63) - 2*X63*X72 + SQR(X72) =G= 0;
E196 .. SQR(X63) + 2*X63*X72 + SQR(X72) =G= 0;
E197 .. SQR(X63) - 2*X63*X73 + SQR(X73) =G= 0;
E198 .. SQR(X63) + 2*X63*X73 + SQR(X73) =G= 0;
E199 .. SQR(X2) - 2*X2*X3 + SQR(X3) =G= 0;
E200 .. SQR(X2) + 2*X2*X3 + SQR(X3) =G= 0;
E201 .. SQR(X2) - 2*X2*X4 + SQR(X4) =G= 0;
E202 .. SQR(X2) + 2*X2*X4 + SQR(X4) =G= 0;
E203 .. SQR(X2) - 2*X2*X5 + SQR(X5) =G= 0;
E204 .. SQR(X2) + 2*X2*X5 + SQR(X5) =G= 0;
E205 .. SQR(X2) - 2*X2*X64 + SQR(X64) =G= 0;
E206 .. SQR(X2) + 2*X2*X64 + SQR(X64) =G= 0;
E207 .. SQR(X2) - 2*X2*X65 + SQR(X65) =G= 0;
E208 .. SQR(X2) + 2*X2*X65 + SQR(X65) =G= 0;
E209 .. SQR(X2) - 2*X2*X66 + SQR(X66) =G= 0;
E210 .. SQR(X2) + 2*X2*X66 + SQR(X66) =G= 0;
E211 .. SQR(X2) - 2*X2*X9 + SQR(X9) =G= 0;
E212 .. SQR(X2) + 2*X2*X9 + SQR(X9) =G= 0;
E213 .. SQR(X3) - 2*X3*X5 + SQR(X5) =G= 0;
E214 .. SQR(X3) + 2*X3*X5 + SQR(X5) =G= 0;
E215 .. SQR(X3) - 2*X3*X64 + SQR(X64) =G= 0;
E216 .. SQR(X3) + 2*X3*X64 + SQR(X64) =G= 0;
E217 .. SQR(X3) - 2*X3*X65 + SQR(X65) =G= 0;
E218 .. SQR(X3) + 2*X3*X65 + SQR(X65) =G= 0;
E219 .. SQR(X3) - 2*X3*X66 + SQR(X66) =G= 0;
E220 .. SQR(X3) + 2*X3*X66 + SQR(X66) =G= 0;
E221 .. SQR(X3) - 2*X3*X9 + SQR(X9) =G= 0;
E222 .. SQR(X3) + 2*X3*X9 + SQR(X9) =G= 0;
E223 .. SQR(X4) - 2*X4*X5 + SQR(X5) =G= 0;
E224 .. SQR(X4) + 2*X4*X5 + SQR(X5) =G= 0;
E225 .. SQR(X4) - 2*X4*X64 + SQR(X64) =G= 0;
E226 .. SQR(X4) + 2*X4*X64 + SQR(X64) =G= 0;
E227 .. SQR(X4) - 2*X4*X65 + SQR(X65) =G= 0;
E228 .. SQR(X4) + 2*X4*X65 + SQR(X65) =G= 0;
E229 .. SQR(X4) - 2*X4*X66 + SQR(X66) =G= 0;
E230 .. SQR(X4) + 2*X4*X66 + SQR(X66) =G= 0;
E231 .. SQR(X4) - 2*X4*X9 + SQR(X9) =G= 0;
E232 .. SQR(X4) + 2*X4*X9 + SQR(X9) =G= 0;
E233 .. SQR(X4) - 2*X4*X67 + SQR(X67) =G= 0;
E234 .. SQR(X4) + 2*X4*X67 + SQR(X67) =G= 0;
E235 .. SQR(X5) - 2*X5*X67 + SQR(X67) =G= 0;
E236 .. SQR(X5) + 2*X5*X67 + SQR(X67) =G= 0;
E237 .. SQR(X5) - 2*X5*X68 + SQR(X68) =G= 0;
E238 .. SQR(X5) + 2*X5*X68 + SQR(X68) =G= 0;
E239 .. SQR(X5) - 2*X5*X69 + SQR(X69) =G= 0;
E240 .. SQR(X5) + 2*X5*X69 + SQR(X69) =G= 0;
E241 .. SQR(X5) - 2*X5*X70 + SQR(X70) =G= 0;
E242 .. SQR(X5) + 2*X5*X70 + SQR(X70) =G= 0;
E243 .. SQR(X5) - 2*X5*X71 + SQR(X71) =G= 0;
E244 .. SQR(X5) + 2*X5*X71 + SQR(X71) =G= 0;
E245 .. SQR(X5) - 2*X5*X72 + SQR(X72) =G= 0;
E246 .. SQR(X5) + 2*X5*X72 + SQR(X72) =G= 0;
E247 .. SQR(X5) - 2*X5*X73 + SQR(X73) =G= 0;
E248 .. SQR(X5) + 2*X5*X73 + SQR(X73) =G= 0;
E249 .. SQR(X64) - 2*X64*X67 + SQR(X67) =G= 0;
E250 .. SQR(X64) + 2*X64*X67 + SQR(X67) =G= 0;
E251 .. SQR(X64) - 2*X64*X68 + SQR(X68) =G= 0;
E252 .. SQR(X64) + 2*X64*X68 + SQR(X68) =G= 0;
E253 .. SQR(X64) - 2*X64*X69 + SQR(X69) =G= 0;
E254 .. SQR(X64) + 2*X64*X69 + SQR(X69) =G= 0;
E255 .. SQR(X64) - 2*X64*X70 + SQR(X70) =G= 0;
E256 .. SQR(X64) + 2*X64*X70 + SQR(X70) =G= 0;
E257 .. SQR(X64) - 2*X64*X71 + SQR(X71) =G= 0;
E258 .. SQR(X64) + 2*X64*X71 + SQR(X71) =G= 0;
E259 .. SQR(X64) - 2*X64*X72 + SQR(X72) =G= 0;
E260 .. SQR(X64) + 2*X64*X72 + SQR(X72) =G= 0;
E261 .. SQR(X64) - 2*X64*X73 + SQR(X73) =G= 0;
E262 .. SQR(X64) + 2*X64*X73 + SQR(X73) =G= 0;
E263 .. SQR(X65) - 2*X65*X67 + SQR(X67) =G= 0;
E264 .. SQR(X65) + 2*X65*X67 + SQR(X67) =G= 0;
E265 .. SQR(X65) - 2*X65*X68 + SQR(X68) =G= 0;
E266 .. SQR(X65) + 2*X65*X68 + SQR(X68) =G= 0;
E267 .. SQR(X65) - 2*X65*X69 + SQR(X69) =G= 0;
E268 .. SQR(X65) + 2*X65*X69 + SQR(X69) =G= 0;
E269 .. SQR(X65) - 2*X65*X70 + SQR(X70) =G= 0;
E270 .. SQR(X65) + 2*X65*X70 + SQR(X70) =G= 0;
E271 .. SQR(X65) - 2*X65*X71 + SQR(X71) =G= 0;
E272 .. SQR(X65) + 2*X65*X71 + SQR(X71) =G= 0;
E273 .. SQR(X65) - 2*X65*X72 + SQR(X72) =G= 0;
E274 .. SQR(X65) + 2*X65*X72 + SQR(X72) =G= 0;
E275 .. SQR(X65) - 2*X65*X73 + SQR(X73) =G= 0;
E276 .. SQR(X65) + 2*X65*X73 + SQR(X73) =G= 0;
E277 .. SQR(X66) - 2*X66*X67 + SQR(X67) =G= 0;
E278 .. SQR(X66) + 2*X66*X67 + SQR(X67) =G= 0;
E279 .. SQR(X66) - 2*X66*X68 + SQR(X68) =G= 0;
E280 .. SQR(X66) + 2*X66*X68 + SQR(X68) =G= 0;
E281 .. SQR(X66) - 2*X66*X69 + SQR(X69) =G= 0;
E282 .. SQR(X66) + 2*X66*X69 + SQR(X69) =G= 0;
E283 .. SQR(X66) - 2*X66*X70 + SQR(X70) =G= 0;
E284 .. SQR(X66) + 2*X66*X70 + SQR(X70) =G= 0;
E285 .. SQR(X66) - 2*X66*X71 + SQR(X71) =G= 0;
E286 .. SQR(X66) + 2*X66*X71 + SQR(X71) =G= 0;
E287 .. SQR(X66) - 2*X66*X72 + SQR(X72) =G= 0;
E288 .. SQR(X66) + 2*X66*X72 + SQR(X72) =G= 0;
E289 .. SQR(X66) - 2*X66*X73 + SQR(X73) =G= 0;
E290 .. SQR(X66) + 2*X66*X73 + SQR(X73) =G= 0;
E291 .. SQR(X9) - 2*X9*X67 + SQR(X67) =G= 0;
E292 .. SQR(X9) + 2*X9*X67 + SQR(X67) =G= 0;
E293 .. SQR(X9) - 2*X9*X68 + SQR(X68) =G= 0;
E294 .. SQR(X9) + 2*X9*X68 + SQR(X68) =G= 0;
E295 .. SQR(X9) - 2*X9*X69 + SQR(X69) =G= 0;
E296 .. SQR(X9) + 2*X9*X69 + SQR(X69) =G= 0;
E297 .. SQR(X9) - 2*X9*X70 + SQR(X70) =G= 0;
E298 .. SQR(X9) + 2*X9*X70 + SQR(X70) =G= 0;
E299 .. SQR(X9) - 2*X9*X71 + SQR(X71) =G= 0;
E300 .. SQR(X9) + 2*X9*X71 + SQR(X71) =G= 0;
E301 .. SQR(X9) - 2*X9*X74 + SQR(X74) =G= 0;
E302 .. SQR(X9) + 2*X9*X74 + SQR(X74) =G= 0;
E303 .. SQR(X9) - 2*X9*X75 + SQR(X75) =G= 0;
E304 .. SQR(X9) + 2*X9*X75 + SQR(X75) =G= 0;
E305 .. SQR(X68) - 2*X68*X69 + SQR(X69) =G= 0;
E306 .. SQR(X68) + 2*X68*X69 + SQR(X69) =G= 0;
E307 .. SQR(X70) - 2*X70*X71 + SQR(X71) =G= 0;
E308 .. SQR(X70) + 2*X70*X71 + SQR(X71) =G= 0;
E309 .. SQR(X72) - 2*X72*X73 + SQR(X73) =G= 0;
E310 .. SQR(X72) + 2*X72*X73 + SQR(X73) =G= 0;
E311 .. SQR(X74) - 2*X74*X75 + SQR(X75) =G= 0;
E312 .. SQR(X74) + 2*X74*X75 + SQR(X75) =G= 0;
E313 .. objvar =E= X0;
