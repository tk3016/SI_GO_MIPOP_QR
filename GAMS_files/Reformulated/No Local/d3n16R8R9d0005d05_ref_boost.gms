...
E23 ..  - 2*X24 + SQR(X24) =G= -1;
E24 .. 2*X24 + SQR(X24) =G= -1;
E25 .. objvar =E= X0;
...
X10.UP = 0;
X11.LO = 0;
X11.UP = 83.43102741851904;
X12.LO = 0;
X12.UP = 98.50460000000008;
X13.LO = 0;
X13.UP = 95.15407586963107;
X14.LO = 0;
X14.UP = 75.4242362267147;
X15.LO = 0;
X15.UP = 88.66422616677839;
X16.LO = 0;
X16.UP = 77.84875870484693;
X0.LO = -110.7293427459675;
X0.UP = 385.6698498118504;
X340.LO = 0.0672;
X340.UP = 4.386810352822991;
X338.LO = 0.3498;
X338.UP = 8.702500000000002;
X341.LO = 0.2604;
X341.UP = 4.658860607261626;
X342.LO = 0;
X342.UP = 5.9536;
X339.LO = 0.2067;
X339.UP = 8.673000000000002;
X1.LO = -0;
X1.UP = 344.6444265598104;
X2.LO = -0;
X2.UP = 298.940603453296;
