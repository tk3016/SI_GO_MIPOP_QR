...
E126 ..  - X31 + X6*X8 =E= 0;
E127 ..  - X30 + X6*X7 =E= 0;
E128 ..  - 2*X6 + SQR(X6) =G= -1;
E129 .. 2*X6 + SQR(X6) =G= -1;
E130 ..  - 2*X7 + SQR(X7) =G= -1;
E131 .. 2*X7 + SQR(X7) =G= -1;
E132 ..  - 2*X8 + SQR(X8) =G= -1;
E133 .. 2*X8 + SQR(X8) =G= -1;
E134 ..  - 2*X9 + SQR(X9) =G= -1;
E135 .. 2*X9 + SQR(X9) =G= -1;
E136 ..  - 2*X10 + SQR(X10) =G= -1;
E137 .. 2*X10 + SQR(X10) =G= -1;
E138 ..  - 2*X11 + SQR(X11) =G= -1;
E139 .. 2*X11 + SQR(X11) =G= -1;
E140 ..  - 2*X12 + SQR(X12) =G= -1;
E141 .. 2*X12 + SQR(X12) =G= -1;
E142 ..  - 2*X13 + SQR(X13) =G= -1;
E143 .. 2*X13 + SQR(X13) =G= -1;
E144 ..  - 2*X29 + SQR(X29) =G= -1;
E145 .. 2*X29 + SQR(X29) =G= -1;
E146 ..  - 2*X34 + SQR(X34) =G= -1;
E147 .. 2*X34 + SQR(X34) =G= -1;
E148 ..  - 2*X35 + SQR(X35) =G= -1;
E149 .. 2*X35 + SQR(X35) =G= -1;
E150 ..  - 2*X36 + SQR(X36) =G= -1;
E151 .. 2*X36 + SQR(X36) =G= -1;
E152 ..  - 2*X37 + SQR(X37) =G= -1;
E153 .. 2*X37 + SQR(X37) =G= -1;
E154 ..  - 2*X38 + SQR(X38) =G= -1;
E155 .. 2*X38 + SQR(X38) =G= -1;
E156 ..  - 2*X39 + SQR(X39) =G= -1;
E157 .. 2*X39 + SQR(X39) =G= -1;
E158 ..  - 2*X40 + SQR(X40) =G= -1;
E159 .. 2*X40 + SQR(X40) =G= -1;
E160 ..  - 2*X41 + SQR(X41) =G= -1;
E161 .. 2*X41 + SQR(X41) =G= -1;
E162 ..  - 2*X42 + SQR(X42) =G= -1;
E163 .. 2*X42 + SQR(X42) =G= -1;
E164 ..  - 2*X43 + SQR(X43) =G= -1;
E165 .. 2*X43 + SQR(X43) =G= -1;
E166 ..  - 2*X44 + SQR(X44) =G= -1;
E167 .. 2*X44 + SQR(X44) =G= -1;
E168 ..  - 2*X45 + SQR(X45) =G= -1;
E169 .. 2*X45 + SQR(X45) =G= -1;
E170 ..  - 2*X46 + SQR(X46) =G= -1;
E171 .. 2*X46 + SQR(X46) =G= -1;
E172 ..  - 2*X47 + SQR(X47) =G= -1;
E173 .. 2*X47 + SQR(X47) =G= -1;
E174 ..  - 2*X48 + SQR(X48) =G= -1;
E175 .. 2*X48 + SQR(X48) =G= -1;
E176 ..  - 2*X49 + SQR(X49) =G= -1;
E177 .. 2*X49 + SQR(X49) =G= -1;
E178 ..  - 2*X50 + SQR(X50) =G= -1;
E179 .. 2*X50 + SQR(X50) =G= -1;
E180 ..  - 2*X51 + SQR(X51) =G= -1;
E181 .. 2*X51 + SQR(X51) =G= -1;
E182 ..  - 2*X52 + SQR(X52) =G= -1;
E183 .. 2*X52 + SQR(X52) =G= -1;
E184 ..  - 2*X53 + SQR(X53) =G= -1;
E185 .. 2*X53 + SQR(X53) =G= -1;
E186 ..  - 2*X54 + SQR(X54) =G= -1;
E187 .. 2*X54 + SQR(X54) =G= -1;
E188 ..  - 2*X55 + SQR(X55) =G= -1;
E189 .. 2*X55 + SQR(X55) =G= -1;
E190 ..  - 2*X56 + SQR(X56) =G= -1;
E191 .. 2*X56 + SQR(X56) =G= -1;
E192 ..  - 2*X57 + SQR(X57) =G= -1;
E193 .. 2*X57 + SQR(X57) =G= -1;
E194 ..  - 2*X58 + SQR(X58) =G= -1;
E195 .. 2*X58 + SQR(X58) =G= -1;
E196 ..  - 2*X59 + SQR(X59) =G= -1;
E197 .. 2*X59 + SQR(X59) =G= -1;
E198 ..  - 2*X60 + SQR(X60) =G= -1;
E199 .. 2*X60 + SQR(X60) =G= -1;
E200 ..  - 2*X61 + SQR(X61) =G= -1;
E201 .. 2*X61 + SQR(X61) =G= -1;
E202 ..  - 2*X62 + SQR(X62) =G= -1;
E203 .. 2*X62 + SQR(X62) =G= -1;
E204 ..  - 2*X63 + SQR(X63) =G= -1;
E205 .. 2*X63 + SQR(X63) =G= -1;
E206 .. SQR(X6) - 2*X6*X7 + SQR(X7) =G= 0;
E207 .. SQR(X6) + 2*X6*X7 + SQR(X7) =G= 0;
E208 .. SQR(X6) - 2*X6*X8 + SQR(X8) =G= 0;
E209 .. SQR(X6) + 2*X6*X8 + SQR(X8) =G= 0;
E210 .. SQR(X6) - 2*X6*X9 + SQR(X9) =G= 0;
E211 .. SQR(X6) + 2*X6*X9 + SQR(X9) =G= 0;
E212 .. SQR(X6) - 2*X6*X10 + SQR(X10) =G= 0;
E213 .. SQR(X6) + 2*X6*X10 + SQR(X10) =G= 0;
E214 .. SQR(X6) - 2*X6*X12 + SQR(X12) =G= 0;
E215 .. SQR(X6) + 2*X6*X12 + SQR(X12) =G= 0;
E216 .. SQR(X6) - 2*X6*X13 + SQR(X13) =G= 0;
E217 .. SQR(X6) + 2*X6*X13 + SQR(X13) =G= 0;
E218 .. SQR(X6) - 2*X6*X37 + SQR(X37) =G= 0;
E219 .. SQR(X6) + 2*X6*X37 + SQR(X37) =G= 0;
E220 .. SQR(X6) - 2*X6*X38 + SQR(X38) =G= 0;
E221 .. SQR(X6) + 2*X6*X38 + SQR(X38) =G= 0;
E222 .. SQR(X6) - 2*X6*X39 + SQR(X39) =G= 0;
E223 .. SQR(X6) + 2*X6*X39 + SQR(X39) =G= 0;
E224 .. SQR(X6) - 2*X6*X40 + SQR(X40) =G= 0;
E225 .. SQR(X6) + 2*X6*X40 + SQR(X40) =G= 0;
E226 .. SQR(X6) - 2*X6*X41 + SQR(X41) =G= 0;
E227 .. SQR(X6) + 2*X6*X41 + SQR(X41) =G= 0;
E228 .. SQR(X6) - 2*X6*X43 + SQR(X43) =G= 0;
E229 .. SQR(X6) + 2*X6*X43 + SQR(X43) =G= 0;
E230 .. SQR(X6) - 2*X6*X44 + SQR(X44) =G= 0;
E231 .. SQR(X6) + 2*X6*X44 + SQR(X44) =G= 0;
E232 .. SQR(X6) - 2*X6*X45 + SQR(X45) =G= 0;
E233 .. SQR(X6) + 2*X6*X45 + SQR(X45) =G= 0;
E234 .. SQR(X6) - 2*X6*X46 + SQR(X46) =G= 0;
E235 .. SQR(X6) + 2*X6*X46 + SQR(X46) =G= 0;
E236 .. SQR(X6) - 2*X6*X47 + SQR(X47) =G= 0;
E237 .. SQR(X6) + 2*X6*X47 + SQR(X47) =G= 0;
E238 .. SQR(X6) - 2*X6*X48 + SQR(X48) =G= 0;
E239 .. SQR(X6) + 2*X6*X48 + SQR(X48) =G= 0;
E240 .. SQR(X6) - 2*X6*X50 + SQR(X50) =G= 0;
E241 .. SQR(X6) + 2*X6*X50 + SQR(X50) =G= 0;
E242 .. SQR(X6) - 2*X6*X51 + SQR(X51) =G= 0;
E243 .. SQR(X6) + 2*X6*X51 + SQR(X51) =G= 0;
E244 .. SQR(X6) - 2*X6*X52 + SQR(X52) =G= 0;
E245 .. SQR(X6) + 2*X6*X52 + SQR(X52) =G= 0;
E246 .. SQR(X6) - 2*X6*X53 + SQR(X53) =G= 0;
E247 .. SQR(X6) + 2*X6*X53 + SQR(X53) =G= 0;
E248 .. SQR(X6) - 2*X6*X54 + SQR(X54) =G= 0;
E249 .. SQR(X6) + 2*X6*X54 + SQR(X54) =G= 0;
E250 .. SQR(X6) - 2*X6*X55 + SQR(X55) =G= 0;
E251 .. SQR(X6) + 2*X6*X55 + SQR(X55) =G= 0;
E252 .. SQR(X6) - 2*X6*X56 + SQR(X56) =G= 0;
E253 .. SQR(X6) + 2*X6*X56 + SQR(X56) =G= 0;
E254 .. SQR(X6) - 2*X6*X57 + SQR(X57) =G= 0;
E255 .. SQR(X6) + 2*X6*X57 + SQR(X57) =G= 0;
E256 .. SQR(X6) - 2*X6*X58 + SQR(X58) =G= 0;
E257 .. SQR(X6) + 2*X6*X58 + SQR(X58) =G= 0;
E258 .. SQR(X6) - 2*X6*X60 + SQR(X60) =G= 0;
E259 .. SQR(X6) + 2*X6*X60 + SQR(X60) =G= 0;
E260 .. SQR(X6) - 2*X6*X62 + SQR(X62) =G= 0;
E261 .. SQR(X6) + 2*X6*X62 + SQR(X62) =G= 0;
E262 .. SQR(X7) - 2*X7*X8 + SQR(X8) =G= 0;
E263 .. SQR(X7) + 2*X7*X8 + SQR(X8) =G= 0;
E264 .. SQR(X7) - 2*X7*X9 + SQR(X9) =G= 0;
E265 .. SQR(X7) + 2*X7*X9 + SQR(X9) =G= 0;
E266 .. SQR(X7) - 2*X7*X10 + SQR(X10) =G= 0;
E267 .. SQR(X7) + 2*X7*X10 + SQR(X10) =G= 0;
E268 .. SQR(X7) - 2*X7*X11 + SQR(X11) =G= 0;
E269 .. SQR(X7) + 2*X7*X11 + SQR(X11) =G= 0;
E270 .. SQR(X7) - 2*X7*X12 + SQR(X12) =G= 0;
E271 .. SQR(X7) + 2*X7*X12 + SQR(X12) =G= 0;
E272 .. SQR(X7) - 2*X7*X13 + SQR(X13) =G= 0;
E273 .. SQR(X7) + 2*X7*X13 + SQR(X13) =G= 0;
E274 .. SQR(X7) - 2*X7*X36 + SQR(X36) =G= 0;
E275 .. SQR(X7) + 2*X7*X36 + SQR(X36) =G= 0;
E276 .. SQR(X7) - 2*X7*X38 + SQR(X38) =G= 0;
E277 .. SQR(X7) + 2*X7*X38 + SQR(X38) =G= 0;
E278 .. SQR(X7) - 2*X7*X42 + SQR(X42) =G= 0;
E279 .. SQR(X7) + 2*X7*X42 + SQR(X42) =G= 0;
E280 .. SQR(X7) - 2*X7*X43 + SQR(X43) =G= 0;
E281 .. SQR(X7) + 2*X7*X43 + SQR(X43) =G= 0;
E282 .. SQR(X7) - 2*X7*X44 + SQR(X44) =G= 0;
E283 .. SQR(X7) + 2*X7*X44 + SQR(X44) =G= 0;
E284 .. SQR(X7) - 2*X7*X45 + SQR(X45) =G= 0;
E285 .. SQR(X7) + 2*X7*X45 + SQR(X45) =G= 0;
E286 .. SQR(X7) - 2*X7*X46 + SQR(X46) =G= 0;
E287 .. SQR(X7) + 2*X7*X46 + SQR(X46) =G= 0;
E288 .. SQR(X7) - 2*X7*X47 + SQR(X47) =G= 0;
E289 .. SQR(X7) + 2*X7*X47 + SQR(X47) =G= 0;
E290 .. SQR(X7) - 2*X7*X48 + SQR(X48) =G= 0;
E291 .. SQR(X7) + 2*X7*X48 + SQR(X48) =G= 0;
E292 .. SQR(X7) - 2*X7*X49 + SQR(X49) =G= 0;
E293 .. SQR(X7) + 2*X7*X49 + SQR(X49) =G= 0;
E294 .. SQR(X7) - 2*X7*X50 + SQR(X50) =G= 0;
E295 .. SQR(X7) + 2*X7*X50 + SQR(X50) =G= 0;
E296 .. SQR(X7) - 2*X7*X51 + SQR(X51) =G= 0;
E297 .. SQR(X7) + 2*X7*X51 + SQR(X51) =G= 0;
E298 .. SQR(X7) - 2*X7*X52 + SQR(X52) =G= 0;
E299 .. SQR(X7) + 2*X7*X52 + SQR(X52) =G= 0;
E300 .. SQR(X7) - 2*X7*X53 + SQR(X53) =G= 0;
E301 .. SQR(X7) + 2*X7*X53 + SQR(X53) =G= 0;
E302 .. SQR(X7) - 2*X7*X55 + SQR(X55) =G= 0;
E303 .. SQR(X7) + 2*X7*X55 + SQR(X55) =G= 0;
E304 .. SQR(X7) - 2*X7*X56 + SQR(X56) =G= 0;
E305 .. SQR(X7) + 2*X7*X56 + SQR(X56) =G= 0;
E306 .. SQR(X7) - 2*X7*X57 + SQR(X57) =G= 0;
E307 .. SQR(X7) + 2*X7*X57 + SQR(X57) =G= 0;
E308 .. SQR(X7) - 2*X7*X59 + SQR(X59) =G= 0;
E309 .. SQR(X7) + 2*X7*X59 + SQR(X59) =G= 0;
E310 .. SQR(X7) - 2*X7*X60 + SQR(X60) =G= 0;
E311 .. SQR(X7) + 2*X7*X60 + SQR(X60) =G= 0;
E312 .. SQR(X7) - 2*X7*X61 + SQR(X61) =G= 0;
E313 .. SQR(X7) + 2*X7*X61 + SQR(X61) =G= 0;
E314 .. SQR(X7) - 2*X7*X62 + SQR(X62) =G= 0;
E315 .. SQR(X7) + 2*X7*X62 + SQR(X62) =G= 0;
E316 .. SQR(X7) - 2*X7*X63 + SQR(X63) =G= 0;
E317 .. SQR(X7) + 2*X7*X63 + SQR(X63) =G= 0;
E318 .. SQR(X8) - 2*X8*X9 + SQR(X9) =G= 0;
E319 .. SQR(X8) + 2*X8*X9 + SQR(X9) =G= 0;
E320 .. SQR(X8) - 2*X8*X10 + SQR(X10) =G= 0;
E321 .. SQR(X8) + 2*X8*X10 + SQR(X10) =G= 0;
E322 .. SQR(X8) - 2*X8*X11 + SQR(X11) =G= 0;
E323 .. SQR(X8) + 2*X8*X11 + SQR(X11) =G= 0;
E324 .. SQR(X8) - 2*X8*X12 + SQR(X12) =G= 0;
E325 .. SQR(X8) + 2*X8*X12 + SQR(X12) =G= 0;
E326 .. SQR(X8) - 2*X8*X13 + SQR(X13) =G= 0;
E327 .. SQR(X8) + 2*X8*X13 + SQR(X13) =G= 0;
E328 .. SQR(X8) - 2*X8*X45 + SQR(X45) =G= 0;
E329 .. SQR(X8) + 2*X8*X45 + SQR(X45) =G= 0;
E330 .. SQR(X8) - 2*X8*X47 + SQR(X47) =G= 0;
E331 .. SQR(X8) + 2*X8*X47 + SQR(X47) =G= 0;
E332 .. SQR(X8) - 2*X8*X48 + SQR(X48) =G= 0;
E333 .. SQR(X8) + 2*X8*X48 + SQR(X48) =G= 0;
E334 .. SQR(X8) - 2*X8*X50 + SQR(X50) =G= 0;
E335 .. SQR(X8) + 2*X8*X50 + SQR(X50) =G= 0;
E336 .. SQR(X8) - 2*X8*X51 + SQR(X51) =G= 0;
E337 .. SQR(X8) + 2*X8*X51 + SQR(X51) =G= 0;
E338 .. SQR(X8) - 2*X8*X52 + SQR(X52) =G= 0;
E339 .. SQR(X8) + 2*X8*X52 + SQR(X52) =G= 0;
E340 .. SQR(X8) - 2*X8*X53 + SQR(X53) =G= 0;
E341 .. SQR(X8) + 2*X8*X53 + SQR(X53) =G= 0;
E342 .. SQR(X8) - 2*X8*X55 + SQR(X55) =G= 0;
E343 .. SQR(X8) + 2*X8*X55 + SQR(X55) =G= 0;
E344 .. SQR(X8) - 2*X8*X56 + SQR(X56) =G= 0;
E345 .. SQR(X8) + 2*X8*X56 + SQR(X56) =G= 0;
E346 .. SQR(X8) - 2*X8*X57 + SQR(X57) =G= 0;
E347 .. SQR(X8) + 2*X8*X57 + SQR(X57) =G= 0;
E348 .. SQR(X8) - 2*X8*X58 + SQR(X58) =G= 0;
E349 .. SQR(X8) + 2*X8*X58 + SQR(X58) =G= 0;
E350 .. SQR(X8) - 2*X8*X59 + SQR(X59) =G= 0;
E351 .. SQR(X8) + 2*X8*X59 + SQR(X59) =G= 0;
E352 .. SQR(X8) - 2*X8*X60 + SQR(X60) =G= 0;
E353 .. SQR(X8) + 2*X8*X60 + SQR(X60) =G= 0;
E354 .. SQR(X8) - 2*X8*X62 + SQR(X62) =G= 0;
E355 .. SQR(X8) + 2*X8*X62 + SQR(X62) =G= 0;
E356 .. SQR(X9) - 2*X9*X10 + SQR(X10) =G= 0;
E357 .. SQR(X9) + 2*X9*X10 + SQR(X10) =G= 0;
E358 .. SQR(X9) - 2*X9*X11 + SQR(X11) =G= 0;
E359 .. SQR(X9) + 2*X9*X11 + SQR(X11) =G= 0;
E360 .. SQR(X9) - 2*X9*X12 + SQR(X12) =G= 0;
E361 .. SQR(X9) + 2*X9*X12 + SQR(X12) =G= 0;
E362 .. SQR(X9) - 2*X9*X13 + SQR(X13) =G= 0;
E363 .. SQR(X9) + 2*X9*X13 + SQR(X13) =G= 0;
E364 .. SQR(X9) - 2*X9*X51 + SQR(X51) =G= 0;
E365 .. SQR(X9) + 2*X9*X51 + SQR(X51) =G= 0;
E366 .. SQR(X9) - 2*X9*X52 + SQR(X52) =G= 0;
E367 .. SQR(X9) + 2*X9*X52 + SQR(X52) =G= 0;
E368 .. SQR(X9) - 2*X9*X53 + SQR(X53) =G= 0;
E369 .. SQR(X9) + 2*X9*X53 + SQR(X53) =G= 0;
E370 .. SQR(X9) - 2*X9*X55 + SQR(X55) =G= 0;
E371 .. SQR(X9) + 2*X9*X55 + SQR(X55) =G= 0;
E372 .. SQR(X9) - 2*X9*X56 + SQR(X56) =G= 0;
E373 .. SQR(X9) + 2*X9*X56 + SQR(X56) =G= 0;
E374 .. SQR(X9) - 2*X9*X57 + SQR(X57) =G= 0;
E375 .. SQR(X9) + 2*X9*X57 + SQR(X57) =G= 0;
E376 .. SQR(X9) - 2*X9*X59 + SQR(X59) =G= 0;
E377 .. SQR(X9) + 2*X9*X59 + SQR(X59) =G= 0;
E378 .. SQR(X9) - 2*X9*X60 + SQR(X60) =G= 0;
E379 .. SQR(X9) + 2*X9*X60 + SQR(X60) =G= 0;
E380 .. SQR(X9) - 2*X9*X61 + SQR(X61) =G= 0;
E381 .. SQR(X9) + 2*X9*X61 + SQR(X61) =G= 0;
E382 .. SQR(X9) - 2*X9*X62 + SQR(X62) =G= 0;
E383 .. SQR(X9) + 2*X9*X62 + SQR(X62) =G= 0;
E384 .. SQR(X9) - 2*X9*X63 + SQR(X63) =G= 0;
E385 .. SQR(X9) + 2*X9*X63 + SQR(X63) =G= 0;
E386 .. SQR(X10) - 2*X10*X11 + SQR(X11) =G= 0;
E387 .. SQR(X10) + 2*X10*X11 + SQR(X11) =G= 0;
E388 .. SQR(X10) - 2*X10*X12 + SQR(X12) =G= 0;
E389 .. SQR(X10) + 2*X10*X12 + SQR(X12) =G= 0;
E390 .. SQR(X10) - 2*X10*X13 + SQR(X13) =G= 0;
E391 .. SQR(X10) + 2*X10*X13 + SQR(X13) =G= 0;
E392 .. SQR(X10) - 2*X10*X54 + SQR(X54) =G= 0;
E393 .. SQR(X10) + 2*X10*X54 + SQR(X54) =G= 0;
E394 .. SQR(X10) - 2*X10*X55 + SQR(X55) =G= 0;
E395 .. SQR(X10) + 2*X10*X55 + SQR(X55) =G= 0;
E396 .. SQR(X10) - 2*X10*X56 + SQR(X56) =G= 0;
E397 .. SQR(X10) + 2*X10*X56 + SQR(X56) =G= 0;
E398 .. SQR(X10) - 2*X10*X58 + SQR(X58) =G= 0;
E399 .. SQR(X10) + 2*X10*X58 + SQR(X58) =G= 0;
E400 .. SQR(X10) - 2*X10*X59 + SQR(X59) =G= 0;
E401 .. SQR(X10) + 2*X10*X59 + SQR(X59) =G= 0;
E402 .. SQR(X10) - 2*X10*X60 + SQR(X60) =G= 0;
E403 .. SQR(X10) + 2*X10*X60 + SQR(X60) =G= 0;
E404 .. SQR(X10) - 2*X10*X62 + SQR(X62) =G= 0;
E405 .. SQR(X10) + 2*X10*X62 + SQR(X62) =G= 0;
E406 .. SQR(X11) - 2*X11*X12 + SQR(X12) =G= 0;
E407 .. SQR(X11) + 2*X11*X12 + SQR(X12) =G= 0;
E408 .. SQR(X11) - 2*X11*X13 + SQR(X13) =G= 0;
E409 .. SQR(X11) + 2*X11*X13 + SQR(X13) =G= 0;
E410 .. SQR(X11) - 2*X11*X29 + SQR(X29) =G= 0;
E411 .. SQR(X11) + 2*X11*X29 + SQR(X29) =G= 0;
E412 .. SQR(X11) - 2*X11*X61 + SQR(X61) =G= 0;
E413 .. SQR(X11) + 2*X11*X61 + SQR(X61) =G= 0;
E414 .. SQR(X11) - 2*X11*X62 + SQR(X62) =G= 0;
E415 .. SQR(X11) + 2*X11*X62 + SQR(X62) =G= 0;
E416 .. SQR(X11) - 2*X11*X63 + SQR(X63) =G= 0;
E417 .. SQR(X11) + 2*X11*X63 + SQR(X63) =G= 0;
E418 .. SQR(X12) - 2*X12*X13 + SQR(X13) =G= 0;
E419 .. SQR(X12) + 2*X12*X13 + SQR(X13) =G= 0;
E420 .. SQR(X12) - 2*X12*X61 + SQR(X61) =G= 0;
E421 .. SQR(X12) + 2*X12*X61 + SQR(X61) =G= 0;
E422 .. SQR(X29) - 2*X29*X34 + SQR(X34) =G= 0;
E423 .. SQR(X29) + 2*X29*X34 + SQR(X34) =G= 0;
E424 .. SQR(X29) - 2*X29*X35 + SQR(X35) =G= 0;
E425 .. SQR(X29) + 2*X29*X35 + SQR(X35) =G= 0;
E426 .. SQR(X29) - 2*X29*X36 + SQR(X36) =G= 0;
E427 .. SQR(X29) + 2*X29*X36 + SQR(X36) =G= 0;
E428 .. SQR(X29) - 2*X29*X43 + SQR(X43) =G= 0;
E429 .. SQR(X29) + 2*X29*X43 + SQR(X43) =G= 0;
E430 .. SQR(X29) - 2*X29*X49 + SQR(X49) =G= 0;
E431 .. SQR(X29) + 2*X29*X49 + SQR(X49) =G= 0;
E432 .. SQR(X29) - 2*X29*X54 + SQR(X54) =G= 0;
E433 .. SQR(X29) + 2*X29*X54 + SQR(X54) =G= 0;
E434 .. SQR(X29) - 2*X29*X58 + SQR(X58) =G= 0;
E435 .. SQR(X29) + 2*X29*X58 + SQR(X58) =G= 0;
E436 .. SQR(X34) - 2*X34*X59 + SQR(X59) =G= 0;
E437 .. SQR(X34) + 2*X34*X59 + SQR(X59) =G= 0;
E438 .. SQR(X34) - 2*X34*X61 + SQR(X61) =G= 0;
E439 .. SQR(X34) + 2*X34*X61 + SQR(X61) =G= 0;
E440 .. SQR(X35) - 2*X35*X36 + SQR(X36) =G= 0;
E441 .. SQR(X35) + 2*X35*X36 + SQR(X36) =G= 0;
E442 .. SQR(X35) - 2*X35*X42 + SQR(X42) =G= 0;
E443 .. SQR(X35) + 2*X35*X42 + SQR(X42) =G= 0;
E444 .. SQR(X35) - 2*X35*X63 + SQR(X63) =G= 0;
E445 .. SQR(X35) + 2*X35*X63 + SQR(X63) =G= 0;
E446 .. SQR(X36) - 2*X36*X39 + SQR(X39) =G= 0;
E447 .. SQR(X36) + 2*X36*X39 + SQR(X39) =G= 0;
E448 .. SQR(X36) - 2*X36*X42 + SQR(X42) =G= 0;
E449 .. SQR(X36) + 2*X36*X42 + SQR(X42) =G= 0;
E450 .. SQR(X36) - 2*X36*X56 + SQR(X56) =G= 0;
E451 .. SQR(X36) + 2*X36*X56 + SQR(X56) =G= 0;
E452 .. SQR(X37) - 2*X37*X43 + SQR(X43) =G= 0;
E453 .. SQR(X37) + 2*X37*X43 + SQR(X43) =G= 0;
E454 .. SQR(X38) - 2*X38*X49 + SQR(X49) =G= 0;
E455 .. SQR(X38) + 2*X38*X49 + SQR(X49) =G= 0;
E456 .. SQR(X39) - 2*X39*X54 + SQR(X54) =G= 0;
E457 .. SQR(X39) + 2*X39*X54 + SQR(X54) =G= 0;
E458 .. SQR(X39) - 2*X39*X61 + SQR(X61) =G= 0;
E459 .. SQR(X39) + 2*X39*X61 + SQR(X61) =G= 0;
E460 .. SQR(X41) - 2*X41*X61 + SQR(X61) =G= 0;
E461 .. SQR(X41) + 2*X41*X61 + SQR(X61) =G= 0;
E462 .. SQR(X42) - 2*X42*X63 + SQR(X63) =G= 0;
E463 .. SQR(X42) + 2*X42*X63 + SQR(X63) =G= 0;
E464 .. SQR(X43) - 2*X43*X44 + SQR(X44) =G= 0;
E465 .. SQR(X43) + 2*X43*X44 + SQR(X44) =G= 0;
E466 .. SQR(X43) - 2*X43*X45 + SQR(X45) =G= 0;
E467 .. SQR(X43) + 2*X43*X45 + SQR(X45) =G= 0;
E468 .. SQR(X43) - 2*X43*X46 + SQR(X46) =G= 0;
E469 .. SQR(X43) + 2*X43*X46 + SQR(X46) =G= 0;
E470 .. SQR(X43) - 2*X43*X48 + SQR(X48) =G= 0;
E471 .. SQR(X43) + 2*X43*X48 + SQR(X48) =G= 0;
E472 .. SQR(X44) - 2*X44*X52 + SQR(X52) =G= 0;
E473 .. SQR(X44) + 2*X44*X52 + SQR(X52) =G= 0;
E474 .. SQR(X48) - 2*X48*X63 + SQR(X63) =G= 0;
E475 .. SQR(X48) + 2*X48*X63 + SQR(X63) =G= 0;
E476 .. SQR(X49) - 2*X49*X51 + SQR(X51) =G= 0;
E477 .. SQR(X49) + 2*X49*X51 + SQR(X51) =G= 0;
E478 .. SQR(X49) - 2*X49*X52 + SQR(X52) =G= 0;
E479 .. SQR(X49) + 2*X49*X52 + SQR(X52) =G= 0;
E480 .. SQR(X49) - 2*X49*X53 + SQR(X53) =G= 0;
E481 .. SQR(X49) + 2*X49*X53 + SQR(X53) =G= 0;
E482 .. SQR(X49) - 2*X49*X62 + SQR(X62) =G= 0;
E483 .. SQR(X49) + 2*X49*X62 + SQR(X62) =G= 0;
E484 .. SQR(X50) - 2*X50*X54 + SQR(X54) =G= 0;
E485 .. SQR(X50) + 2*X50*X54 + SQR(X54) =G= 0;
E486 .. SQR(X51) - 2*X51*X58 + SQR(X58) =G= 0;
E487 .. SQR(X51) + 2*X51*X58 + SQR(X58) =G= 0;
E488 .. SQR(X52) - 2*X52*X61 + SQR(X61) =G= 0;
E489 .. SQR(X52) + 2*X52*X61 + SQR(X61) =G= 0;
E490 .. SQR(X54) - 2*X54*X55 + SQR(X55) =G= 0;
E491 .. SQR(X54) + 2*X54*X55 + SQR(X55) =G= 0;
E492 .. SQR(X54) - 2*X54*X57 + SQR(X57) =G= 0;
E493 .. SQR(X54) + 2*X54*X57 + SQR(X57) =G= 0;
E494 .. SQR(X56) - 2*X56*X61 + SQR(X61) =G= 0;
E495 .. SQR(X56) + 2*X56*X61 + SQR(X61) =G= 0;
E496 .. SQR(X58) - 2*X58*X59 + SQR(X59) =G= 0;
E497 .. SQR(X58) + 2*X58*X59 + SQR(X59) =G= 0;
E498 .. SQR(X59) - 2*X59*X61 + SQR(X61) =G= 0;
E499 .. SQR(X59) + 2*X59*X61 + SQR(X61) =G= 0;
E500 .. SQR(X61) - 2*X61*X62 + SQR(X62) =G= 0;
E501 .. SQR(X61) + 2*X61*X62 + SQR(X62) =G= 0;
E502 .. SQR(X62) - 2*X62*X63 + SQR(X63) =G= 0;
E503 .. SQR(X62) + 2*X62*X63 + SQR(X63) =G= 0;
E504 .. objvar =E= X0;
...
X6.L = 1.070038450482932;
X7.L = 2.79;
X8.L = 2.051264094679319;
X9.L = 0.52;
X10.L = 1.418071529763431;
X11.L = 0.8230057229918638;
X12.L = 2.14;
X13.L = 0.7204321244569872;
